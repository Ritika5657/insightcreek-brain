...
# Import TextCleaner from the separate module (must exist at code/text_cleaner.py)
from text_cleaner import TextCleaner

# Ensure NLTK resources are available (safe to call; quiet)
import nltk
...
def main(args):
    ...
    # Dynamic n_splits for safety on small datasets
    n_splits = min(5, max(2, len(y_train)))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data", type=str, default="data/clean_sales_data.csv",
                        help="CSV with note_text,label")
    parser.add_argument("--out", type=str, default="models/lead_pipeline.joblib",
